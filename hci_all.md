...
ส่วนที่ 2: แนวทางของความต้องการเบื้องต้นในการทำงาน
ส่วนที่ 3: ความต้องการทางการแสดงภาพ
ส่วนที่ 4: ความต้องการทางคีย์บอร์ด
ส่วนที่ 5: โครงสร้างของการตั้งเครื่องคอมพิวเตอร์
ส่วนที่ 6: แนวทางของสิ่งแวดล้อมในการทำงาน

---

# มาตรฐานโดยทั่วไปเกี่ยวกับสิ่งที่ช่วยเรียนรู้หรือแก้ปัญหาในการใช้งาน (2/2)

ส่วนที่ 7: ความต้องการสำหรับการแสดงภาพสะท้อน
ส่วนที่ 8: ความต้องการสำหรับการแสดงสี
ส่วนที่ 9: ความต้องการสำหรับการการรับข้อมูลนำเข้าที่ไม่ใช่คีย์บอร์ด
ส่วนที่ 10: หลักการในการใช้บทสนทนาโต้ตอบ
ส่วนที่ 11: แนวทางในการใช้ประโยชน์
ส่วนที่ 12: การแสดงข้อมูล
ส่วนที่ 13: แนวทางของผู้ใช้
ส่วนที่ 14: แนวทางของการใช้เมนูบทสนทนา
ส่วนที่ 15: บทสนทนาที่เป็นคำสั่ง
ส่วนที่ 16: บทสนทนาที่เป็นการสั่งการโดยตรง
ส่วนที่ 17: บทสนทนาที่ใช้เติมในฟอร์ม
...
ปัจจุบันสื่อประสมใช้ได้ทั้งภาพนิ่ง เสียง ข้อคาม และภาพเคลื่อนไหว มีอุปกรณ์ที่เกี่ยวข้อง อาทิ เครื่องวีดีโอ เทปเสียง ซีดีรอม กล้องดิจิทัล โทรทัศน์ แล้วเกิดคำใหม่ว่า สถานีปฏิบัติการมัลติมีเดีย (Multimedia workstation) ที่เกิดจากการทำงานร่วมกันของทั้งฮาร์ดแวร์และซอฟต์แวร์
